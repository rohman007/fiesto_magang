...
if ($jenis=='featuredmarquee' || $jenis=='categorymarquee') {
	...
	if (mysql_num_rows($result)>0) {
		...
		while (list($photo_id, $photo_cat_id, $photo_filename, $photo_title, $photo_published, $photo_ishot, $keterangansingkat, $harganormal, $diskon, $matauang, $nilai_disc, $harga_disc) = mysql_fetch_row($result)) {
