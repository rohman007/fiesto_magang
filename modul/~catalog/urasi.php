...
if ($pakaimarketplaceurl) {
	...
	$marketplaces = array('lazada' => _LAZADA, 'tokopedia' => _TOKOPEDIA, 'bukalapak' => _BUKALAPAK, 'shopee' => _SHOPEE);
...
//js untuk front end
echo <<<END
<script type="text/javascript" src="$cfg_app_url/js/zoom/jquery.elevateZoom-3.0.8.min.js"></script>
<script src="$cfg_app_url/modul/catalog/js/catalog.js"></script>
