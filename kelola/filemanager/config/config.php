...
//$cfg_app_url
$base_url="$cfg_app_url"; 
 // DON'T TOUCH (base url (only domain) of site (without final /)).
//$base_url=$httpdomain."/kelola";  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir ="/file/media/source/"; // path from base_url to base of upload folder (with start and final /)
$current_path ="../../file/media/source/"; // relative path from filemanager folder to upload folder (with final /)
$thumbs_base_path = "../../file/media/thumbs/"; // relative path from filemanager folder to thumbs folder (with final /)
...
if(file_exists(DIR_IMAGES."/source")==false){
mkdir(DIR_IMAGES."/source",0777);
}
if(file_exists(DIR_IMAGES."/thumbs")==false){
mkdir(DIR_IMAGES."/thumbs",0777);
}
...
$ext_file = array('doc', 'docx','rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv','html','xhtml','psd','sql','log','fla','xml','ade','adp','mdb','accdb','ppt','pptx','odt','ots','ott','odb','odg','otp','otg','odf','ods','odp','css','ai', 'webp'); //Files
