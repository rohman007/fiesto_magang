...
?>
	...
	<div id="content-center">
		<div id="slogans" class="content-wrapper">
			<div class="container">
			<?php echo $template->content('slogans_teks');?>
			</div>
		</div>
		<div id="produk" class="content-wrapper">
			<div class="container-fluid">
				<div class="row flex-row-reverse d-flex flex-wrap">
					<div class="col-sm-12 col-sm-6">
						<div class="judul">
							<?php echo $template->content('produk_teks');?>
						</div>
						<div class="dua text-center">
							<img src="<?php echo $template->image_url('produk_Image1');?>">
						</div> 
						<div class="lima text-center">
							<img src="<?php echo $template->image_url('produk_Image2');?>">
						</div>
					</div>
					<div class="col-sm-12 col-sm-6 flex-xs-column-reverse d-flex flex-wrap">
					<div class="satu text-center">
							<img src="<?php echo $template->image_url('produk_Image3');?>">
						</div>
						<div class="tiga text-center">
							<img src="<?php echo $template->image_url('produk_Image4');?>">
						</div>
						<div class="tentang">
							<?php echo $template->content('Button_teks');?>
							<br>
		...
		<div id="menuss" class="content-wrapper">
			<?php echo $template->content('Menus_teks1');?>
			<?php echo $template->content('Menus_teks2');?>
			<a href="#" class="btn btn-default more">To Menu</a>
		</div>

		<div id="maps" class="content-wrapper" style="position: relative;">
			<?php echo $template->content('Maps_Image');?>
				<div class="kotakkecil text-center">
		...
		<div class="kotakkecilnone text-center">
				<a class="navbar-brand-footer" href="<?php echo $cfg_app_url ?>"><img src="<?php echo $template->image_url('logo');?>" alt="Logo"></a>
				<?php echo $template->content('Hidden_teks');?>
			</div>
		</div>

		<div id="galery" class="content-wrapper">
			<div class="row">
				<div class="nyah">
				<div class="col-md-3">
					<img src="<?php echo $template->image_url('galery_Image5');?>">
				</div>
				<div class="col-md-3">
					<img src="<?php echo $template->image_url('galery_Image6');?>">
				</div>
				</div>
				<div class="hilang">
					<div class="col-md-3">
					...
					<!-- <div class="col-md-2">
						<img src="<?php echo $template->image_url('galery_Image3');?>">
					</div>
					<div class="col-md-2">
						<img src="<?php echo $template->image_url('galery_Image4');?>">
					</div> -->
				</div>
			</div>
		</div>

		<div id="bawah" class="content-wrapper">
			<div class="container-fluid text-center">
				<a class="navbar-brand-footer" href="<?php echo $cfg_app_url ?>"><img src="<?php echo $template->image_url('logo');?>" alt="Logo"></a>
				<?php echo $template->content('teks_bawah');?>
			</div>
		</div>
